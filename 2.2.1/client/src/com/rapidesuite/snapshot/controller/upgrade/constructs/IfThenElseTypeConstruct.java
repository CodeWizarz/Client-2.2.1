...
public class IfThenElseTypeConstruct extends GenericConstruct{
	...
	public IfThenElseTypeConstruct(UpgradeEngine upgradeEngine) {
		super(upgradeEngine);
	}
	...
	public void process(IfThenElseType ifThenElseType,
		...
		LoopRecordsTypeConstruct.genericProcessing(upgradeEngine,ifThenElseTypeArray,targetTypeArray,
