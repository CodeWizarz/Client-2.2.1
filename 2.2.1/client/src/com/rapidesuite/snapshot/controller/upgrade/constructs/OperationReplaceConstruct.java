...
public class OperationReplaceConstruct extends GenericConstruct{
	...
	public OperationReplaceConstruct(UpgradeEngine upgradeEngine) {
		super(upgradeEngine);
	}
	...
	public void process(OperationType operationType, Map<String, String> variableToValueMap, String[] sourceDataRow,
		...
		String value=upgradeEngine.getUpgradeController().getConstantNameToValueMap().get(textToSearch);
		if (value==null) {
			value=textToSearch;
		}
		String replacementTextValue=upgradeEngine.getUpgradeController().getConstantNameToValueMap().get(replacementText);
