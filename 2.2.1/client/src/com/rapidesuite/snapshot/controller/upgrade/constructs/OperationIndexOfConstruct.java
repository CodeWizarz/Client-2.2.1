...
public class OperationIndexOfConstruct extends GenericConstruct{
	...
	public OperationIndexOfConstruct(UpgradeEngine upgradeEngine,boolean isFirstIndexOf) {
		super(upgradeEngine);
	...
	public void process(OperationType operationType, Map<String, String> variableToValueMap, String[] sourceDataRow,
		...
		String textToSearchValue=upgradeEngine.getUpgradeController().getConstantNameToValueMap().get(textToSearch);
