...
public class OperationDecodeConstruct extends GenericConstruct{
	...
	public OperationDecodeConstruct(ConvertEngine convertEngine) {
		super(convertEngine);
	}
	...
	public void process(OperationType operationType, Map<String, String> variableToValueMap, String[] sourceDataRow,
		...
		if (sharedMapName!=null) {
			com.rapidesuite.client.dataConversionShared0000.ValueMapType[] sharedValueMapTypeArray=convertEngine.getConvertController().getSharedMappings(sharedMapName);
