...
public class OperationSplitConstruct extends GenericConstruct{
	...
	public OperationSplitConstruct(ConvertEngine convertEngine) {
		super(convertEngine);
	}
	...
	public void process(OperationType operationType, Map<String, String> variableToValueMap, String[] sourceDataRow,
		...
		String constantSeparator=convertEngine.getConvertController().getConstantNameToValueMap().get(separator);
		...
		String[] splitOutVariables=convertEngine.getSplitVariableTextToArrayMap().get(outVariables);
		if (splitOutVariables==null) {
			splitOutVariables=outVariables.split(",");
			convertEngine.getSplitVariableTextToArrayMap().put(outVariables, splitOutVariables);
		}
