...
public class XULGetElementTemplate extends HTMLTemplate
{

	private XULEngine engine;

	public XULGetElementTemplate(String templateName)
	{
		super(templateName);
	}
	...
	public void execute(HTMLEngine htmlEngine) throws Exception
	{
		...
		{
			res.append(engine.STEPS_LIST_VAR + " = \"getElementByTextNode('" + tagName + "','" + attributeValue + "');\"; \n");
		}
		else
		{
