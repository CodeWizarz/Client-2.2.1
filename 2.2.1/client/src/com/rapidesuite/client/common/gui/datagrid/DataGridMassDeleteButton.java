...
public class DataGridMassDeleteButton extends GenericButton {
		
	private DataGridController dataGridController;
	
	public DataGridMassDeleteButton(DataGridController dataGridController,ImageIcon imageIcon) {
		super(imageIcon);
