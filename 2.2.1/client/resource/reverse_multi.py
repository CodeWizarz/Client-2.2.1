...
javaArguments += ' -DREVERSE_ZIP_FILE_LOCATION='+os.path.join(multiuser_path_setting.rapid_client_directory, 'zip-files')   
javaArguments += ' -DREVERSE_OUTPUT_FOLDER='+os.path.join(multiuser_path_setting.rapid_client_directory, 'output')   
javaArguments += ' -DREVERSE_SESSIONS_FOLDER='+os.path.join(multiuser_path_setting.rapid_client_directory, 'sessions')   
...
cmd = javaCmd + "  " + javaArguments+" -cp "+cp+" com.rapidesuite.reverse.ReverseMain"
