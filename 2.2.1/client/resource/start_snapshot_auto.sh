...
# $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/programs/2.2.1/client/resource/start_snapshot_auto.sh $
# $Id: start_snapshot_auto.sh 72025 2019-05-09 09:32:55Z warangkana.yoomieng $
##############################################################################
...
python /opt/res/rapidsnapshot/start_snapshot_auto_multi.py a=$1
